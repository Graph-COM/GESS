...
class EGNN(nn.Module):
    def __init__(self, x_dim, pos_dim, model_config, feat_info, n_categorical_feat_to_use=-1, n_scalar_feat_to_use=-1,
                 **kwargs):
        super().__init__()
        ...
        edges_in_d = hidden_size if self.dataset_name == "Track" else 0
    ...
    def forward(self, x, pos, edge_attr, edge_index, batch, edge_attn=None, node_attn=None, with_enc=True):
        ...
        edge_attr = self.edge_encoder(edge_attr) if self.dataset_name == "Track" else None
